...
public class AddProducts extends CommonPageObject {
    public WebDriver edriver;
    public WebDriverWait ewait;
    DataField dataField;

    public AddProducts() throws Exception {
    ...
    public void test() throws Exception {
        ...
        for(int i = 0; i < 4; i++){
            WebElement quantity = quantityInCart.get(i);
            Assert.assertEquals(dataField.getData(i,4),quantity.getText());
        }
        Assert.assertEquals(dataField.getData(0,5),numberCart.getText());
